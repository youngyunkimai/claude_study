...
STEP 1  요구사항 문서 생성
   ↓
STEP 2  RED — 테스트 케이스 작성 (컴파일 에러 확인)
   ↓
...
AI가 생성한 코드를 `test_calculator.c`에 덮어씁니다:

```bash
# 생성된 코드를 test_calculator.c에 저장 후
...
```
fatal error: calculator.h: No such file or directory
```
